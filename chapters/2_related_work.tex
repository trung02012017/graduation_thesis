...
\begin{figure}[!ht] 
   \centering
   \includegraphics[width=0.75\textwidth]{pdf/model/model_ffnn}
...
\begin{figure}[!ht] 
   \centering
   \includegraphics[width=0.75\textwidth]{pdf/model/model_cfnn}
...
\begin{figure}[!ht] 
   \centering
   \includegraphics[width=0.75\textwidth]{png/rnn_unrolled}
...
\begin{figure}[!ht] 
   \centering
   \includegraphics[width=0.75\textwidth]{/png/cloud_models}
